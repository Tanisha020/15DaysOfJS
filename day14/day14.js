...
//Task 2:
individual.changeAge(29);   // Output: Updated age: 29
...
const learner = new Learner('Ravi', 22, '987654');
console.log(learner.getId());   // Output: 987654
...
const studentA = new StudentBase('Anita', 21, '5678');
const studentB = new StudentBase('Sita', 23, '910');
...
const personDetail = new PersonDetail('Rina', 'Gupta');
console.log(personDetail.completeName); // Output: Rina Gupta

//Task 8:
personDetail.completeName = 'Kiran Rao';
console.log(personDetail.completeName); // Output: Kiran Rao
